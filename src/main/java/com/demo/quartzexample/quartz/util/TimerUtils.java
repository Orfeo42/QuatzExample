package com.demo.quartzexample.quartz.util;
...
public final class TimerUtils {
    ...
    public static Trigger buildTrigger(final Class<? extends Job> jobClass, final TimerInfo info) {
        ...
        if (info.isRunForever()) builder = builder.repeatForever();
        else builder = builder.withRepeatCount(info.getTotalFireCount() - 1);
